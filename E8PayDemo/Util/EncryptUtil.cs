...
namespace E8PayDemo.Util
{
    ...
    public static class EncryptUtil
    {
        ...
        /// <returns></returns>
        public static string RSA(string data, string privateKey, string signType = "RSA2")
        {
        ...
        /// <param name="signType">签名类型</param>
        /// <returns></returns>
        public static bool RSAVerifyData(string data, string sign, string publicKey, string signType = "RSA2")
        {
        ...
        /// <returns></returns>
        public static string SHA1Encode(IDictionary<string, string> pairs, string KeyStr)
        {
            string SHAStr = $"{string.Join("&", pairs.Select(d => $"{d.Key}={d.Value}"))}{KeyStr}";
            var data = SHA1.Create().ComputeHash(Encoding.UTF8.GetBytes(SHAStr));
